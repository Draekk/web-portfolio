  ...
  return (
    <section className="flex flex-col gap-y-3 text-white">
      ...
      <p className="lg:text-xl">
        ...
        temporibus mollitia magni! Lorem ipsum dolor sit amet consectetur
        adipisicing elit. Quis unde, quaerat laboriosam quibusdam porro
        perferendis dolores fugiat alias tenetur excepturi assumenda placeat
        ullam corporis nihil reiciendis culpa sit quae modi. Lorem ipsum dolor
